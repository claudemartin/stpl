...
/**
 * The instruction set. The position ({@link #ordinal()}) defines which number
 * is used to represent the instruction.
 *
...
public enum Instruction {
	...
	/**
	 * Write the cardinality (size) of SET to DESTINATION.
	 * <p>
	 * CARDINALITY(DESTINATION, SET);
	 */
	CARDINALITY(ADDRESS, ADDRESS),

	/**
	 * Write {SET} to DESTINATION.
	 * <p>
	 * WRAP(DESTINATION, SET);
	 */
	...
	/**
	 * Write sum of SET1 and SET2 to DESTINATION. Both SET1 and SET2 must contain
	 * valid {@link ValueSet}s.
	 * <p>
	 * SUM(DESTINATION, SET1, SET2);
	 */
	SUM(ADDRESS, ADDRESS, ADDRESS),
	/**
	 * Write product of SET1 and SET2 to DESTINATION. Both SET1 and SET2 must
	 * contain valid {@link ValueSet}s.
	 * <p>
	 * PROD(DESTINATION, SET1, SET2);
	 */
	PROD(ADDRESS, ADDRESS, ADDRESS),
	/**
	 * Write division result of SET1 divided by SET2 to DESTINATION. Both SET1 and
	 * SET2 must contain valid {@link ValueSet}s. This is integer division and the
	 * result is also a {@link ValueSet}.
	 * <p>
	...
	READ_CHAR(ADDRESS),
	/**
	 * Read user input as string and store it at given ADDRESS. String will be
	 * terminated by ∅.
	 * <p>
	 * READ_STRING(ADDRESS);
	 */
	...
	JUMP_BY(ORDINAL),
	/**
	 * Jump forward as many instuctions as given in DISTANCE address, if CONDITION
	 * is not ∅.
	 *
	 * <p>
	...
	/**
	 * Jump back as many instuctions as given in DISTANCE address, if CONDITION is
	 * not ∅.
	 *
	 * <p>
